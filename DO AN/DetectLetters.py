    ...
    for current_letter in list_matching_letters:
        for compare_letter in list_matching_letters:
            if current_letter != compare_letter:
                # nếu true thì 2 ký này có khả năng bị trùng lắp lên nhau
...
def regconize_letters_in_plate(img_original, img_thresh, list_matching_letters):
